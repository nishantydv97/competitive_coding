...
class Solution{
public:	
    int partition(char *arr, int low, int high, int pivit){
        int i=low;
    ...
    void quickSort(char *nuts, char *bolts, int low, int high){
        if(low<high){
            int part1=partition(nuts, low, high, bolts[high]);
            int part2=partition(bolts, low, high, nuts[part1]);
            quickSort(nuts, bolts, low, part1-1);
            quickSort(nuts, bolts, part1+1, high);
        }
    }
